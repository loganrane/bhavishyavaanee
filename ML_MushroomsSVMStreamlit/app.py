...
def main():
    # Exploratory Text to give a gist of the web app.
    ...
    # Function to Split the dataset and cache it.
    @st.cache(persist=True)
    def split(df):
        y = df.type
    ...
    # Plotting of different types of metrics 
    ...
    # Choice to choose the classifier to use.
